...
def get_tags(image_path, fashion_client):
  ...
  required_tags['user_id'] = 'user_456'
  required_tags['skin_tone'] = 3
  required_tags['body_shape'] = 'hourglass'
  required_tags['genere'] = 'western_wear'
  required_tags['gender'] = 'women'
...
async def main(device = device, net = net, fashion_client = fashion_client):
    ...
    async def message_handler(msg):
        ...
        image = image.save("test_whatsapp.png")
        image = np.array((Image.open("test_whatsapp.png")).convert('RGB'))
